...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="thumbnail">
                        <a href="#"><img src="images/deal2.png" alt="..."></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="thumbnail">
                        <a href="#"><img src="images/deal3.png" alt="..."></a>
                    </div>
                </div>
            </div>
                   ...
                   LIMIT 4";
                                ...
                                while($orow = mysql_fetch_array($orslt)) {
                                    ...
                                    if($oname != 'temp') {
                                        ...
                                        <li class="news-item">An order to <?php echo $res_name; ?> restaurant was placed by <?php echo $oname; ?>
                                            at <?php echo $otime; ?></li>
                                        <li class="news-item">An order to <?php echo $res_name; ?> restaurant was placed by <?php echo $oname; ?>
                                            at <?php echo $otime; ?></li>
                                        <li class="news-item">An order to <?php echo $res_name; ?> restaurant was placed by <?php echo $oname; ?>
                                            at <?php echo $otime; ?></li>
    ...
    <div>
        <div class="panel panel-default">
            <div class="panel-body">
                <h4>EWYN - Eat Where You Need</h4>
              <!--  Eat Where You Need -


                So relax, sit back, and enjoy your meal via our deals! -->

                <p>Is basically a food delivery application which offers customer the opportunity to find enormous range of restaurants. No need to go to the restaurant and take away your parcel as all the restaurants covered in our application are up to the mark with the latest items in their menu.</p>
                <p>Latest orders placed by customers and the featured deals of different restaurants can be observed on the homepage. Moreover, restaurant managers are given access to control their particular restaurant menu.</p>
                 ...
                 <p>With EWYN, you can order food online without leaving your couch at home or your desk at work.</p>
    ...
    <div>
        ...
        <div class="row">
            ...
            <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 809px; height: 150px; overflow: hidden;">
                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 809px; height: 150px; overflow: hidden;">
                    ...
                    <?php
                    $resquery = "SELECT * FROM restaurant ORDER by id DESC";
                    $resresult = mysql_query($resquery) or die(mysql_error());
                    while($resrow = mysql_fetch_array($resresult)) {
                        $dp = $resrow['thumbnail'];
                    ?>
                        <div class="thumbnail">
                            <img u="image" src="<?php echo $dp; ?>" />
        ...
        <span u="arrowright" class="jssora03r" style="top: 123px; right: 8px;">
            ...
            <div class="col-md-2">
                <h2 style="font-family: bon; font-size: 50px; color:#428bca;">And Many More!</h2>
            </div>
        </div>
    </div>
